...
import { ArrowLeft as ArrowLeftBase } from 'lucide-react';
import { Button } from '@/components/ui/button';

const ArrowLeft = ArrowLeftBase as React.ComponentType<any>;

function TestsPageContent() {
  /** Tests hub is isolated from inbox-demo URL state (userId, apiKey, env, brand, etc.). */
  const backHref = '/';
  ...
  return (
    <div className="flex h-screen w-screen flex-col bg-background text-foreground">
      <header className="flex items-center gap-3 border-b border-border px-4 py-3">
        ...
        <h1 className="text-sm font-semibold">Tests</h1>
      </header>
