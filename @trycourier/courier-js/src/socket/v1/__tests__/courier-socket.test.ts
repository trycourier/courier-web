...
import { ServerActionEnvelope, InboxMessageEventEnvelope, ServerAction } from "../../../types/socket/protocol/v1/messages";
...
class CourierSocketTestImplementation extends CourierSocket {
  ...
  public onMessageReceived(_: ServerActionEnvelope | InboxMessageEventEnvelope): Promise<void> {
    return Promise.resolve();
  }
