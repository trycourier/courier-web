...
Courier.shared.courierUserAgentName = "courier-vue";
...
export { useCourier } from "./composables/use-courier";
export type {
  UseCourierResult,
  AuthenticationHooks,
  InboxHooks,
  ToastHooks,
  PreferencesHooks,
} from "./composables/use-courier";

export { vNodeToHTMLElement, unmountHTMLElement } from "./utils/render";
