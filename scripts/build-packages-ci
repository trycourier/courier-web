...
echo "Building @trycourier/courier-ui-toast..."
yarn workspace @trycourier/courier-ui-toast run build:ci || exit $?

echo "Building @trycourier/courier-ui-preferences..."
yarn workspace @trycourier/courier-ui-preferences run build:ci || exit $?
...
echo "Building @trycourier/courier-vue..."
yarn workspace @trycourier/courier-vue run build:ci || exit $?

echo "Building @trycourier/courier-angular..."
yarn workspace @trycourier/courier-angular run build:ci || exit $?
